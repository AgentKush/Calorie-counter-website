...
A **📅 Weekly planner** lets you slot recipes into Mon–Sun (from the recipe page or the planner view), shows each day's planned calories and a weekly average, and generates a **🛒 grocery list** of whole, buyable items — recipe measures like "1 clove garlic" or "1/4 onion" become shoppable quantities ("Garlic", "1 Onion"), merged across the week. Copy it straight to your clipboard (paste into Notes or Messages) or download it as a plain-text checklist — no spreadsheet needed.
